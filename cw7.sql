...
SELECT course, AVG(score) AS avg_score FROM students GROUP BY course HAVING AVG(score)>80;

SELECT name,score FROM `students` WHERE city='Chennai' OR city='Mumbai';
